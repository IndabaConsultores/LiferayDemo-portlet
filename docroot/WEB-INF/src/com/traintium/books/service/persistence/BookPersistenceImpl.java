...
import com.traintium.books.NoSuchBookException;
import com.traintium.books.model.Book;
import com.traintium.books.model.impl.BookImpl;
import com.traintium.books.model.impl.BookModelImpl;
...
public class BookPersistenceImpl extends BasePersistenceImpl<Book>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPID =
		new FinderPath(BookModelImpl.ENTITY_CACHE_ENABLED,
			...
			BookModelImpl.ANIO_COLUMN_BITMASK);
	 ...
	 * @throws com.traintium.books.NoSuchBookException if a matching book could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	 ...
	 * @throws com.traintium.books.NoSuchBookException if a book with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	@Override
	public Book updateImpl(com.traintium.books.model.Book book)
		throws SystemException {
		book = toUnwrappedModel(book);
	...
	protected Book toUnwrappedModel(Book book) {
		...
		bookImpl.setNombre(book.getNombre());
		bookImpl.setAutor(book.getAutor());
		bookImpl.setAnio(book.getAnio());
	...
	/**
	 * Returns the book with the primary key or throws a {@link com.traintium.books.NoSuchBookException} if it could not be found.
	 *
	 * @param bookId the primary key of the book
	 * @return the book
	 * @throws com.traintium.books.NoSuchBookException if a book with the primary key could not be found
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.traintium.books.model.Book")));
